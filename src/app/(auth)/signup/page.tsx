  ...
  return (
    <div className="space-y-6">
        <div className="flex items-center gap-3 mb-2">
            <h1 className="text-2xl font-bold text-[#E8EDF5]">Create Account</h1>
        ...
        <p className="text-[#8899BB]">Join the refined RefractOne Hub v2.5.1 and start generating intelligence reports</p>
      ...
      <p className="text-center text-[#8899BB] text-sm">
        ...
        <Link href="/signin" className="text-teal-600 hover:text-teal-500 font-medium transition-colors">
          Sign in
        </Link>
      </p>
    </div>
